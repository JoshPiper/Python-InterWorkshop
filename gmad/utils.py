...
def read_until_null(file):
    """
    Read a file pointer until it reaches a null byte,
    returning an array of byte objects.
    """
    return_data = b""
...
def read_null_string(file):
    """
    Read a null terminated string from a filer pointer,
...
def read_int(file, length=4, edian='little'):
    ...
    returning an int of byte length and edian encoding.
    """
